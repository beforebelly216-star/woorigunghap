...
export function AccountDeletionPanel() {
  ...
  return <section className="account-delete-panel">
    ...
    {open ? <div className="account-delete-box" id="account-delete-details">
      <h2>회원탈퇴</h2>
      <p>탈퇴하면 카카오 계정 연결과 로그인 세션이 삭제되고, 보관함의 리포트 원문·출생정보·재열람 접근정보와 인연 네트워크 연결정보도 삭제되어 복구할 수 없습니다.</p>
      ...
      <button type="button" className="account-delete-button" disabled={loading || confirmation !== "탈퇴"} onClick={deleteAccount}>{loading ? "처리 중..." : "계정과 보관함 삭제"}</button>
