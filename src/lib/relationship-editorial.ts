...
export const RELATIONSHIP_EDITORIAL: Record<RelationshipType, RelationshipEditorialProfile> = {
  crush: {
    ...
    mustCover: ["다가가는 속도", "상대 반응을 확인하는 기준", "부담을 줄이는 연락·제안 방식", "혼자 의미를 과해석하지 않는 기준"],
  ...
  flirting: {
    ...
    mustCover: ["연락 리듬", "호감 표현의 균형", "관계 정의 대화", "밀고 당기기보다 확인 가능한 행동"],
  ...
  lover: {
    ...
    mustCover: ["애정표현", "연락·데이트 리듬", "갈등 후 회복", "주도권과 역할 분담", "장기 관계 유지 습관"],
  ...
  friend: {
    ...
    mustCover: ["연락 빈도", "약속 신뢰", "함께 하기 좋은 활동", "서로 필요한 거리", "갈등 후 어색함을 푸는 방식"],
  ...
  coworker: {
    ...
    mustCover: ["업무 속도", "역할 분담", "보고·의사결정 방식", "피드백 주고받기", "갈등을 업무 이슈로 분리하는 법"],
