...
export default function TermsPage() {
  return <PolicyPage title="이용약관" updatedAt="2026-09-01">
    ...
    <PolicySection title="3. 결제·공급·재열람">
      ...
      <p>완료된 유료 결과는 복구키 또는 로그인 계정 보관함에서 재열람할 수 있습니다. 저장된 구매 결과를 다시 열 때 점수 계산이나 AI 생성을 다시 수행하지 않습니다.</p>
      <p>로그인 상태에서 만든 무료 인연 네트워크는 30일의 네트워크 보관 기간 동안 계정 보관함에서 다시 열 수 있습니다. 계정 저장은 공개 결과 링크를 다시 찾는 기능이며, 참여 제어·삭제를 위한 방장 관리 권한은 해당 기기 또는 별도로 보관한 관리 링크에만 유지됩니다.</p>
    </PolicySection>
    <PolicySection title="4. 청약철회·환불">
      <p>{OPERATING_POLICY.refundSummary}</p><p>상세 조건은 환불·청약철회 안내를 따릅니다.</p>
    </PolicySection>
    <PolicySection title="5. 계정과 탈퇴">
      <p>서비스 기능 이용 전 카카오 로그인이 필요합니다. 회원은 보관함에서 저장된 구매 결과와 자신이 만든 무료 인연 네트워크를 확인할 수 있으며 탈퇴를 요청할 수 있습니다.</p>
      <p>탈퇴 시 계정 식별정보·세션·리포트 원문, 유료 결과와 무료 인연 네트워크의 계정 재열람 연결정보를 삭제하고, 법령상 보존 의무가 있는 최소 거래기록은 별도 목적에 한해 보존합니다.</p>
    </PolicySection>
