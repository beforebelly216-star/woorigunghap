...
export default function PrivacyPage() {
  return <PolicyPage title="개인정보처리방침" updatedAt="2026-08-23">
    ...
    <PolicySection title="5. 이용자의 권리">
      <p>이용자는 자신의 개인정보에 대해 열람·정정·삭제·처리정지 등을 요청할 수 있습니다. 로그인 회원은 보관함에서 개별 구매 결과 삭제 또는 회원탈퇴와 데이터 삭제를 요청할 수 있으며, 비회원은 고객지원 채널을 통해 삭제를 요청할 수 있습니다.</p>
    </PolicySection>
